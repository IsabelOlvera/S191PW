...
<div class="content-container">
    ...
    <div class="card news-card">
        ...
        <div class="card-body">
            ...
            <h5 class="card-title">{{__('La Biblioteca de la Media Noche')}}</h5>
            <p>
            ...
            <a href="https://vanguardia.com.mx/opinion/sobre-la-biblioteca-de-la-medianoche-GB1399877" target="_blank" class="btn btn-vintage">{{__('Ver más...')}}</a>
        </div>
    </div>
</div>
@endsection
